...
fact {
	...
	-- F7: Detento comum só pode ficar em cela comum
...
-- EXISTENTES, ou seja, quando rodar, necessariamente irá encontrar instâncias
...
-- INEXISTENTES, ou seja, quando rodar, não irá encontrar instâncias
